...
class RideHistoryScreen extends StatelessWidget {
  ...
  Widget _buildHeader(BuildContext context) {
    return Container(
      ...
      child: Row(children: [
        ...
        Text('Ride History', style: GoogleFonts.notoSansTamil(
  ...
  Widget _emptyState() => Center(child: Column(
    ...
    children: [
      ...
      Text('இன்னும் rides இல்லை!',
        style: GoogleFonts.notoSansTamil(fontSize: 16, color: kText)),
      const SizedBox(height: 6),
      const Text('முதல் ride book பண்ணுங்க!',
...
class _RideHistoryCard extends StatelessWidget {
  ...
  Color _statusColor(String s) {
    switch (s) {
      ...
      case 'accepted':  return kGold;
      case 'cancelled': return kOrange;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          Text(rideType == 'Auto' ? '🛺' : rideType == 'Parcel' ? '📦' : '🏍️',
          ...
          Container(
            ...
            child: Text(status.toUpperCase(),
              style: TextStyle(fontSize: 8, color: _statusColor(status),
                fontWeight: FontWeight.w800))),
          const SizedBox(width: 8),
          Text('₹${fare.toInt()}', style: const TextStyle(
            fontSize: 16, fontWeight: FontWeight.w800, color: kGold)),
        ]),
        ...
        Padding(padding: const EdgeInsets.only(left: 3),
          child: Container(width: 2, height: 10, color: kBorder,
        ...
        if (rating > 0) ...[
          ...
          Text(List.generate(5, (i) => i < rating ? '⭐' : '').join(),
